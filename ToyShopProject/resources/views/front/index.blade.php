  ...
  <div class="container">
    <div class="row row-20 justify-content-md-between">
      ...
      <div class="col-md-6 col-lg-3 text-center text-md-end d-lg-flex justify-right-md"><a
          class="btn btn-sm btn-primary-variant-1 align-middle-md" href="/front/product/productAllList">馬上進入商品區</a>
      </div>
    </div>
  </div>
  <!-- PhotoSwipe-->
...
<section class="section-top-50 section-sm-top-66">
  ...
  <div class="row g-0 offset-md-top-64" data-lightgallery="group">
    <div class="col-sm-6 col-lg-3"><a class="thumbnail-gallery" data-lightgallery="item"
        href="front/images/play-rule01.png"><img width="480" height="351" src="front/images/play-rule01.png"
          alt=""></a>
    </div>
    <div class="col-sm-6 col-lg-3"><a class="thumbnail-gallery" data-lightgallery="item"
        href="front/images/play-rule02.png"><img width="480" height="351" src="front/images/play-rule02.png"
          alt=""></a>
    </div>
    <div class="col-sm-6 col-lg-3"><a class="thumbnail-gallery" data-lightgallery="item"
        href="front/images/play-rule03.png"><img width="480" height="351" src="front/images/play-rule03.png"
          alt=""></a>
    </div>
    <div class="col-sm-6 col-lg-3"><a class="thumbnail-gallery" data-lightgallery="item"
        href="front/images/play-rule04.png"><img width="480" height="351" src="front/images/play-rule04.png"
          alt=""></a>
    </div>
  </div>
</section>
      ...
      <div class="col-sm-12 col-lg-6">
        ...
        <form method="post" action="/front/contact">
          ...
          <div class="floating-label-wrap">
            <input class="form-input text-info" type="text" name="name" id="contact-name" placeholder=" " required>
            <label class="form-label" for="contact-name">姓名</label>
          </div>
          <div class="floating-label-wrap">
            <input class="form-input text-info" type="text" name="phone" id="contact-phone" placeholder=" " pattern="09\d{8}" required>
            <label class="form-label" for="contact-phone">電話號碼</label>
            <div class="text-danger" id="telephoneError"></div>
          </div>
          <div class="floating-label-wrap">
            <input class="form-input text-info" type="text" name="email" id="contact-email" placeholder=" " required>
          ...
          <div class="text-center">
            <button class="btn btn-primary-variant-1 btn-sm btn-min-width-lg offset-top-20" id="registerButton" type="submit">送出</button>
          </div>
        </form>
      </div>
    </div>
