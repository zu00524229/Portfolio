...
<section class="section-top-50 section-sm-top-100">
    <div class="container mt-5" style="max-width: 1500px; text-align: left;">
        ...
        <div class="container d-flex justify-content-between align-items-center mt-4" style="margin-top: 30px; max-width: 100%;">
            <!-- 關鍵字搜尋 -->
            <form id="searchForm" action="/front/product/productAllList" method="GET" class="d-flex">
        ...
        <div class="container" style="margin-top: 30px; max-width: 100%;">
            <div class="row mb-5">
                        ...
                        <div class="col-md-3 mt-1 mb-4">
                            <div class="card shadow-sm border-0 rounded-3" style="height: 380px;" data-lightgallery="group">
                                ...
                                <div class="badge-container position-absolute top-0 end-0 p-2">
                                    <span class="badge bg-success">{{ $data->stock }} / {{ $data->totalCount }}</span>
                                </div>
                ...
                <div class="col-12 mt-4">
                    <div class="d-flex justify-content-between align-items-center mb-1">
                        <h3 class="text-muted mb-4 fs-2">熱門主打商品</h3>
                    </div>
                    <div id="productCarousel" class="carousel slide" data-bs-ride="carousel">
                        <div class="carousel-inner">
                            @foreach($productsByUpdateTime->chunk(4) as $index => $chunk)
                                ...
                                <div class="row mb-5">
                                    ...
                                    <div class="col-md-3">
                                        <div class="card shadow-sm border-0 rounded-3" style="height: 380px;" data-lightgallery="group">
                                            ...
                                            <div class="badge-container position-absolute top-0 end-0 p-2">
                                                <span class="badge bg-danger">{{ $data->stock }} / {{ $data->totalCount }}</span>
                                            </div>
                ...
                <div class="col-12 mt-4">
                    <div class="d-flex justify-content-between align-items-center mb-1">
                        <h3 class="text-muted mb-4 fs-2">所有商品區</h3>
                    </div>
...
<script>
    document.getElementById('resetButton').addEventListener('click', function() {
        ...
        form.submit();
        // 重新導向到基礎網址
        window.location.href = '/front/product/productAllList';
    });
</script>
@endsection