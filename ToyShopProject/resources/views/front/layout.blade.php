        ...
        <header class="section page-head page-head-default">
            ...
            <div class="rd-navbar-wrap bg-transparent">
                <nav class="rd-navbar" data-layout="rd-navbar-fixed" data-sm-layout="rd-navbar-fixed"
                    ...
                    data-xl-layout="rd-navbar-static" data-xl-device-layout="rd-navbar-static" data-xxl-layout="rd-navbar-static"
                    data-xxl-device-layout="rd-navbar-static" data-lg-stick-up-offset="46px" data-xl-stick-up-offset="117px"
                    data-xxl-stick-up-offset="117px" data-lg-stick-up="true" data-xl-stick-up="true" data-xxl-stick-up="true">
                    <div class="rd-navbar-inner">
                        ...
                        <div class="rd-navbar-nav-wrap">
                            <ul class="rd-navbar-nav">
                                ...
                                <li class="rd-nav-item"><a class="rd-nav-link" href="/front/product/productAllList">商品專區</a></li>
                                <li class="rd-nav-item"><a class="rd-nav-link" href="/front/player/playerInfo">玩家專區</a></li>
                                <li class="rd-nav-item"><a class="rd-nav-link" href="/front/player/recharge">儲值專區</a></li>
                                <li class="rd-nav-item"><a class="rd-nav-link" href="/front/cart/list">購物車</a></li>
                                <li class="rd-nav-item"><a class="rd-nav-link" href="/admin/login" style="color:rgb(26, 189, 118);">後臺專區</a></li>
                            </ul>
                        </div>
                        <!-- 註冊/登入或使用者區域 -->
                        <div class="d-flex bd-highlight">
                            ...
                            <div class="dropdown user-dropdown ms-5" id="player-dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="playerDropdown">
                                    <!-- 顯示玩家的點數 -->
                                    <li class="dropdown-item">點數：<span id="user-points">{{ session('point') ?? 0 }} 點</span></li>
