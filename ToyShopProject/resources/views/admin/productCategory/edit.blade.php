            ...
            <div class="col-md-6 col-lg-5"> <!-- 控制表單寬度 -->
                <div class="card shadow-sm mt-4">
                    <div class="card-body">
                        ...
                        <form action="/admin/productCategory/update" method="POST" enctype="multipart/form-data">
                            <input type="hidden" name="Id" value="{{ $list->Id }}">
                            @csrf <!-- Laravel 防止跨站請求偽造 -->
                            <!-- 主標題 -->
                            <div class="mb-3">
                                <label for="title" class="form-label">類別名稱</label>
                                <input type="text" name="name" id="name" class="form-control" value="{{ $list->name }}" autofocus>
                            </div>
