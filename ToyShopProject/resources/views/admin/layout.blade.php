                ...
                <ul class="navbar-nav ms-auto"> <!-- 使用 ms-auto 將內容靠右對齊 -->
                    <li class="nav-item">
                        <form action="/admin/logout" method="POST"> <!-- 登出按鈕 -->
                            <!-- Laravel CSRF Token -->
                            @csrf
                            <button type="submit" class="btn btn-outline-danger btn-lg"><i class="bi bi-door-closed-fill"></i> 登出</button>
                        </form>
                    </li>
                </ul>
            </div> <!--end::Container-->
        ...
        <aside class="app-sidebar bg-body-secondary shadow" data-bs-theme="dark"> <!--begin::Sidebar Brand-->
            <div class="sidebar-brand"> <!--begin::Brand Link-->
                <a href="/admin/home" class="brand-link"> <!--begin::Brand Image-->
                    <img src="../../../admin/images/logo.png" class="brand-image" style="width: 80px; height: 80px;"> <!--end::Brand Image--> <!--begin::Brand Text-->
